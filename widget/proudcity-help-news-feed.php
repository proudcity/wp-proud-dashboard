...
class Proud_Help_News_Feed
{
    ...
    private static $url = 'http://help.proudcity.com/category/featured';
    ...
    public static function news_widget()
    {
        ...
        if (is_wp_error($feed)) {
            echo self::get_rss_error();
            return;
        }
        $feed->set_cache_duration(43200); // cached for 12 hours in seconds is 43200
